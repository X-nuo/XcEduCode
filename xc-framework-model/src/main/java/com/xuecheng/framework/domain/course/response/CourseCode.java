...
public enum CourseCode implements ResultCode {
    COURSE_GET_NOTEXISTS(false, 31000, "获取课程失败！"),
    ...
    COURSE_PUBLISH_CREATEINDEXERROR(false, 31006, "创建课程索引信息出错！"),
    COURSE_MEDIA_URLISNULL(false,31101,"选择的媒资文件访问地址为空！"),
    COURSE_MEDIA_NAMEISNULL(false,31102,"选择的媒资文件名称为空！"),
    COURSE_MEDIA_TEACHPLANISNULL(false, 311003, "课程计划为空!"),
    COURSE_MEDIA_TEACHPLANGRADEISERROR(false, 311004, "课程计划级别错误！");
